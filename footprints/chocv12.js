...
module.exports = {
  ...
  (footprint "ceoloide:switch_choc_v1_v2"
    ...
    function make_diode(y, side) {
      return `
    ${''/* diode symbols */}
    (fp_line (start 0.25 ${y})     (end 0.75 ${y})   (layer ${side}.SilkS) (width 0.1))
    (fp_line (start 0.25 ${y+0.4}) (end -0.35 ${y})  (layer ${side}.SilkS) (width 0.1))
    (fp_line (start 0.25 ${y-0.4}) (end 0.25 ${y+0.4})    (layer ${side}.SilkS) (width 0.1))
    (fp_line (start -0.35 ${y})    (end 0.25 ${y-0.4})   (layer ${side}.SilkS) (width 0.1))
    (fp_line (start -0.35 ${y})    (end -0.35 ${y+0.55})  (layer ${side}.SilkS) (width 0.1))
    (fp_line (start -0.35 ${y})    (end -0.35 ${y-0.55}) (layer ${side}.SilkS) (width 0.1))
    (fp_line (start -0.75 ${y})    (end -0.35 ${y})  (layer ${side}.SilkS) (width 0.1))

    ${''/* SMD pads on both sides */}
    (pad 1 smd rect (at -1.65 ${y} ${p.r}) (size 0.9 1.2) (layers ${side}.Cu ${side}.Paste ${side}.Mask) ${p.to_diode})
    (pad 2 smd rect (at  1.65 ${y} ${p.r}) (size 0.9 1.2) (layers ${side}.Cu ${side}.Paste ${side}.Mask) ${p.to})
    `
    }
